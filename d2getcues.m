function    [ct,ref_time,fs,fn,recdir] = d2getcues(recdir,prefix,suffix)
%
...
if isempty(C),
    ...
    fprintf(' Generating cuetab for %s - will take a few seconds\n', suffix) ;
    cuefname = socal_makecuefile(recdir,prefix,suffix) ;
    if isempty(cuefname),
