...
PRESS=struct;
PRESS.POLY=[-6.66	3016.25	-127.32];
PRESS.METHOD='rough';
...
ACC.POLY=[5.007	-2.468;	4.982	-2.496;	5.048	-2.509] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[743.996 -227.457; 782.724	-232.648; 784.875 -230.093] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
