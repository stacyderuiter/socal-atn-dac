...
PRESS=struct;
PRESS.POLY=[-25.28	3016.12	-133.5];
PRESS.METHOD='rough';
...
ACC.POLY=[4.994 -2.484; 4.990 -2.471; 5.059 -2.545] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[738.947	-198.564;	775.140	-251.575;	762.688	-276.691] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
