...
ACC.POLY=[5.000	-2.466;	4.959	-2.518;	4.989	-2.464] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[692.952	-226.244;	728.388	-285.438;	767.642	-177.846] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
