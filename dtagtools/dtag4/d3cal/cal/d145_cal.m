...
PRESS=struct;
PRESS.POLY=[45.79 2877.69 -105.99];
PRESS.METHOD='rough';
...
ACC.POLY=[4.982 2.436; 4.985 -2.509; 5.059 -2.529];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[730.840 -251.900; 748.060 -234.980; 719.010 -258.060];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
