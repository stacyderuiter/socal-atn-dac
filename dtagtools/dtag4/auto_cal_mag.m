...
%      temperature sensor. This allows for a fast changing temperature
...
%      A negative tc specifies the amount to delay T by in seconds. Because tc is negative,
%      this is always effectively an advance of -tc seconds. This time
%      advance can be used to partially compensate for a slow-responding
%      temperature sensor.
%
%		Results:
...
fa = 1 ;             % target analysis sampling rate in Hz
