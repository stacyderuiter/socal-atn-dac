...
PRESS=struct;
PRESS.POLY=[24.15 2937.73 -119.13];
PRESS.METHOD='rough';
...
ACC.POLY=[4.976 -2.425; 5.039 -2.524; 5.050 -2.515] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[666.180 -235.480; 689.830 -205.230; 713.040 -212.190];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
