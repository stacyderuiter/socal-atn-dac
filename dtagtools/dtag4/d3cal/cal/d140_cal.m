...
PRESS=struct;
PRESS.POLY=[-20.53	2924.99	-117.03];
PRESS.METHOD='rough';
...
ACC.POLY=[4.974 -2.464; 4.924 -2.488; 4.980 -2.493] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[679.564 -171.908; 713.828 -237.301; 741.882 -234.783] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
